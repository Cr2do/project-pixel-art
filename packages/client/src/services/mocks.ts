import { IUser, UserRole, IPixelBoard, PixelBoardStatus } from '@/types';

const MOCK_USER_ID = '665a1b2c3d4e5f6a7b8c9d01';
...
export const MOCK_PIXELBOARDS: IPixelBoard[] = [
  {
    ...
    delay_seconds: 30,
    contributions: [
      { userId: MOCK_USER_ID, nb_pixels_placed: 42, is_author: false },
  ...
  },
  {
    ...
    delay_seconds: 60,
    contributions: [
      { userId: MOCK_USER_ID, nb_pixels_placed: 15, is_author: false },
  ...
  },
  {
    ...
    delay_seconds: 10,
    contributions: [
      { userId: MOCK_USER_ID, nb_pixels_placed: 256, is_author: false },
  ...
  },
  {
    ...
    delay_seconds: 120,
    contributions: [
      { userId: MOCK_USER_ID, nb_pixels_placed: 88, is_author: false },
    ],
